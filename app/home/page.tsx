...
import { FundDao, fetchAllDAOs, joinDao } from "../../utils";
...
export default function Home() {
    ...
    function CardsDAO({
        ...
        async function joinDaoCall() {
            await joinDao(formInput.joinAmount, daoId);
        }

        async function fundDao() {
            await FundDao(formInput.fundAmount, daoId)
        }
            ...
            <div className="flex justify-center mt-10 w-[100%]">
                <div className="flex w-[70%] gap-5 p-6 cursor-pointer bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <div className="flex flex-col justify-between w-[100%]">
                        ...
                        <div className="">
                            <button
                                className=" text-center mb-[10px] h-[50px] w-[140px] inline-flex justify-center items-center px-3 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                                onClick={pushPage}
                            >
                            ...
                            <div className="flex gap-[4%]">
                                ...
                                <div className="w-[10%]">
                                    <input
                                        ...
                                        placeholder="50 Toks"
                                        required
                                        value={formInput.joinAmount}
                                        onChange={(e) => {
                                            setFormInput({
                                                ...formInput,
                                                joinAmount: e.target.value,
                                            });
                                        }}
                                    />
                                </div>
