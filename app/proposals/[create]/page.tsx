...
export default function Home() {
    ...
    async function createProposalCall() {
        setLoading(true);
        await createProposal(formInput.proposalName, formInput.problemUrl);
        setLoading(false);
    }
